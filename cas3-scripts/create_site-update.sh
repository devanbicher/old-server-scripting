#!/bin/bash
#
# Usage --> sh create_site-update.sh <sitename> 
#
...
sed -i "s/DATABASE_NAME/$1"'_2019'"/" $1/settings.php;
...
echo "$1.cas3.lehigh.edu   has been created on cas-drupal-dev.dept.lehigh.edu. Using the create_site-update.sh script

      Add the following line to the sites.php file UNLESS IT IS ALREADY IN THERE:
              '$1.cas3.lehigh.edu' => '$1',
